...
<!--<script src="./assets/js/preloader.js"></script>-->
  ...
  $(document).ready(function() {
		...
		function loadAssociates(){
			$.ajax({
				url: `${baseUrl}/api/admin/associates/`,
				type: 'GET',
				headers: {
		...
		$('#data-table').on('click', '.btn-view-user', function() {
			...
			$.ajax({
				...
				success: function(user) {
					...
					$('#userAdminName').text(`${user.workflow_configuration.home_manager.first_name} ${user.workflow_configuration.home_manager.last_name}`);
					$('#userAdminId').text(user.workflow_configuration.home_manager.associate_id);
